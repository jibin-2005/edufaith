...
// Fetch students from teacher's class with their Exam 2 marks
$sql = "SELECT u.id, u.username, r.marks, r.updated_at 
        FROM users u 
        JOIN classes c ON u.class_id = c.id 
        LEFT JOIN results r ON u.id = r.student_id AND r.exam_type = 'exam_2'
...
<head>
    <meta charset="UTF-8">
    <title>Main Exam 2 Results | Teacher</title>
    <link rel="stylesheet" href="../css/dashboard.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        .exam-header { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; padding: 20px; border-radius: 8px; margin-bottom: 25px; }
        .table-container { background: white; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); }
        table { width: 100%; border-collapse: collapse; }
        th, td { padding: 12px; text-align: left; border-bottom: 1px solid #eee; }
        .edit-btn { background: #e74c3c; color: white; padding: 5px 12px; border: none; border-radius: 4px; cursor: pointer; font-size: 12px; }
...
<body>
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="results_exam1.php"><i class="fa-solid fa-chart-line"></i> Results - Exam 1</a></li>
            <li><a href="results_exam2.php" class="active"><i class="fa-solid fa-chart-bar"></i> Results - Exam 2</a></li>
        </ul>
    ...
    <div class="main-content">
        <div class="top-bar">
            <h2>Manage Results - Main Exam 2</h2>
            <div class="user-profile"><span><?= htmlspecialchars($_SESSION['username']) ?></span></div>
        </div>

        <div class="exam-header">
            <h3 style="margin: 0 0 10px 0;"><i class="fa-solid fa-graduation-cap"></i> Main Exam 2</h3>
    ...
    <div id="editModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:1000;">
        <div style="background:white; width:400px; margin:100px auto; padding:25px; border-radius:8px;">
            ...
            <form method="POST" action="../includes/save_result_process.php">
                ...
                <input type="hidden" name="exam_type" value="exam_2">
                ...
                <div style="text-align:right;">
                    ...
                    <button type="submit" style="padding:10px 20px; background:#f5576c; color:white; border:none; border-radius:4px; cursor:pointer;">Save Marks</button>
                </div>
            </form>
        </div>
    </div>
